...
Pod::Spec.new do |spec|
  ...
  spec.name         = "ResourceX"
  spec.version      = "1.1"
  spec.summary      = "ResourceX 通过AFNetworking YYModel 解析网络封装的网络请求"
  ...
  spec.description  = <<-DESC
                              "ResourceX 通过AFNetworking YYModel 解析网络封装的网络请求"
                   DESC
  ...
  # Or just: spec.author    = "JadenTeng"
  # spec.authors            = { "JadenTeng" => "781232284@qq.com" }
  # spec.social_media_url   = "https://twitter.com/JadenTeng"
  ...
  # spec.dependency "ResourceX", "~> 1.0.0"
